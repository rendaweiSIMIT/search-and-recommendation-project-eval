...
def _resolve_paired_pool_map(
    ...
    """Translate a comma-separated list of fids (e.g. "62,63,64,65,66,89,90,91")
...
def main() -> None:
    ...
    # as a comma-separated string (default "62,63,64,65,66,89,90,91"); we
    # resolve it against the schema here so the eval-time RankMixerNSTokenizer
    # uses the exact same set of paired fids as during training. Empty /
    # missing -> empty dict, which keeps the fallback identical to baseline.
