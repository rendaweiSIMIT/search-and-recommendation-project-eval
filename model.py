...
class PCVRHyFormer(nn.Module):
    ...
    def __init__(
        ...
        # baseline behavior. Each solo branch sets exactly one fid via
        # --explicit_{user,item}_int_fids so we can isolate that fid's
        # gain instead of confounding it with combo effects.
